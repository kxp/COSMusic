...
namespace EndUserApp.prxTranslator {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="MyTranslatorSoap", Namespace="http://tempuri.org/")]
    public partial class MyTranslator : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public MyTranslator() {
            this.Url = global::EndUserApp.Properties.Settings.Default.EndUserApp_prxTranslator_MyTranslator;
        ...
        /// <remarks/>
        public void TranslateAsync(string sentence, string srcLang, string dstLang) {
            this.TranslateAsync(sentence, srcLang, dstLang, null);
        }
        
        /// <remarks/>
        public void TranslateAsync(string sentence, string srcLang, string dstLang, object userState) {
            ...
            this.InvokeAsync("Translate", new object[] {
                        sentence,
                        srcLang,
                        dstLang}, this.TranslateOperationCompleted, userState);
        }
